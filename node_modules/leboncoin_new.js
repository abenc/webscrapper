...
exports.postAndScrap = function (req,res){
  ...
  console.log(url);
      ...
      req.session.json.marque = getProp("marque",data).capitalizeFirstLetter();
      ...
      req.session.json.urlLacentrale="http://www.lacentrale.fr/cote-voitures-"+marque+"-"+modele+"-"+replaceSpaceParTiret(req.session.json.titre)+"-"+anneeModele+"-.html";
...
function replaceSpaceParTiret(chaine){
